...
public class OSSController {
    ...
    public Resp<Object> policy(){
        ...
        String accessId = "LTAI4Fe96zJFR5ZqGcoSbAdf"; // 请填写您的AccessKeyId。
        String accessKey = "9Yw6tRnnwwNvBgAMVia3VsWhKnivj6"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "xnc20190615"; // 请填写您的 bucketname 。
