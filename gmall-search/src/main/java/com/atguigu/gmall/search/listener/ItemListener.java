...
public class ItemListener {
    ...
    public  void  listener(Map<String, Object> map){
        ...
        if (StringUtils.equals("insert", type)||StringUtils.equals("updata", type)){
            {
            ...
            skuInfoEntities.forEach(skuInfoEntity -> {
                Delete delete = new Delete.Builder(skuInfoEntity.getSkuId().toString()).index("goods").type("index").build();
                try {
